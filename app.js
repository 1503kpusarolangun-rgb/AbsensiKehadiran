...
function initDB() {
  ...
  const users = [
    ...
    { id:'u2', nip:'197511102009101001', nama:'Aswal', golongan:'PNS', pangkat:'IVa',
      jabatan:'Sekretaris', unit:'KPU Kab. Sarolangun', email:'aswal@kpu.go.id', hp:'08222222222',
      username:'Aswal', password:'Aswal123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Aswal+Yura&background=1565c0&color=fff&size=80' },
    { id:'u3', nip:'197410022006042008', nama:'Mutiyah Pitri', golongan:'PNS', pangkat:'IIId',
      jabatan:'Kasubbag Hukum dan SDM', unit:'KPU Kab. Sarolangun', email:'mutiyahpitri@kpu.go.id', hp:'08333333333',
      username:'Mutiyah', password:'Mutiyah123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Mutiyah+Pitri&background=2e7d32&color=fff&size=80' },
    ...
    { id:'u5', nip:'198501012010011001', nama:'Administrator KPU', golongan:'PNS', pangkat:'IVa',
      jabatan:'Administrator Sistem', unit:'Sekretariat', email:'admin@kpu.go.id', hp:'08111111111',
      username:'admin', password:'admin123', role:'admin', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Admin+KPU&background=c62828&color=fff&size=80' },
    ...
    { id:'u7', nip:'199503152019081001', nama:'Budi Santoso', golongan:'PPPK', pangkat:'IIIb',
    ...
    { id:'u8', nip:'198808202012042002', nama:'Dewi Rahayu', golongan:'PNS', pangkat:'IIIb',
      jabatan:'Pengelola Keuangan', unit:'Bagian Keuangan', email:'dewi@kpu.go.id', hp:'08444444444',
      username:'dewi', password:'dewi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Dewi+Rahayu&background=6a1b9a&color=fff&size=80' },
    { id:'u9', nip:'198501012010011001', nama:'Administrator KPU', golongan:'PNS', pangkat:'IVa',
      jabatan:'Administrator Sistem', unit:'Sekretariat', email:'admin@kpu.go.id', hp:'08111111111',
      username:'admin', password:'admin123', role:'admin', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Admin+KPU&background=c62828&color=fff&size=80' },
    { id:'u10', nip:'199001012015032001', nama:'Sri Tutut', golongan:'PNS', pangkat:'IIIa',
      jabatan:'Pranata Komputer', unit:'Bagian TI', email:'sritutut@kpu.go.id', hp:'08222222222',
      username:'pegawai', password:'pegawai123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Sri+Tutut&background=1565c0&color=fff&size=80' },
    { id:'u11', nip:'199503152019081001', nama:'Budi Santoso', golongan:'PPPK', pangkat:'IIIb',
      jabatan:'Analis Kebijakan', unit:'Divisi Perencanaan', email:'budi@kpu.go.id', hp:'08333333333',
      username:'budi', password:'budi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Budi+Santoso&background=2e7d32&color=fff&size=80' },
    { id:'u12', nip:'198808202012042002', nama:'Dewi Rahayu', golongan:'PNS', pangkat:'IIIb',
      jabatan:'Pengelola Keuangan', unit:'Bagian Keuangan', email:'dewi@kpu.go.id', hp:'08444444444',
      username:'dewi', password:'dewi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Dewi+Rahayu&background=6a1b9a&color=fff&size=80' },
    { id:'u13', nip:'198501012010011001', nama:'Administrator KPU', golongan:'PNS', pangkat:'IVa',
      jabatan:'Administrator Sistem', unit:'Sekretariat', email:'admin@kpu.go.id', hp:'08111111111',
      username:'admin', password:'admin123', role:'admin', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Admin+KPU&background=c62828&color=fff&size=80' },
    { id:'u14', nip:'199001012015032001', nama:'Sri Tutut', golongan:'PNS', pangkat:'IIIa',
      jabatan:'Pranata Komputer', unit:'Bagian TI', email:'sritutut@kpu.go.id', hp:'08222222222',
      username:'pegawai', password:'pegawai123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Sri+Tutut&background=1565c0&color=fff&size=80' },
    { id:'u15', nip:'199503152019081001', nama:'Budi Santoso', golongan:'PPPK', pangkat:'IIIb',
      jabatan:'Analis Kebijakan', unit:'Divisi Perencanaan', email:'budi@kpu.go.id', hp:'08333333333',
      username:'budi', password:'budi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Budi+Santoso&background=2e7d32&color=fff&size=80' },
    { id:'u16', nip:'198808202012042002', nama:'Dewi Rahayu', golongan:'PNS', pangkat:'IIIb',
      jabatan:'Pengelola Keuangan', unit:'Bagian Keuangan', email:'dewi@kpu.go.id', hp:'08444444444',
      username:'dewi', password:'dewi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Dewi+Rahayu&background=6a1b9a&color=fff&size=80' },
    { id:'u17', nip:'198501012010011001', nama:'Administrator KPU', golongan:'PNS', pangkat:'IVa',
      jabatan:'Administrator Sistem', unit:'Sekretariat', email:'admin@kpu.go.id', hp:'08111111111',
      username:'admin', password:'admin123', role:'admin', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Admin+KPU&background=c62828&color=fff&size=80' },
    { id:'u18', nip:'199001012015032001', nama:'Sri Tutut', golongan:'PNS', pangkat:'IIIa',
      jabatan:'Pranata Komputer', unit:'Bagian TI', email:'sritutut@kpu.go.id', hp:'08222222222',
      username:'pegawai', password:'pegawai123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Sri+Tutut&background=1565c0&color=fff&size=80' },
    { id:'u19', nip:'199503152019081001', nama:'Budi Santoso', golongan:'PPPK', pangkat:'IIIb',
      jabatan:'Analis Kebijakan', unit:'Divisi Perencanaan', email:'budi@kpu.go.id', hp:'08333333333',
      username:'budi', password:'budi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Budi+Santoso&background=2e7d32&color=fff&size=80' },
    { id:'u20', nip:'198808202012042002', nama:'Dewi Rahayu', golongan:'PNS', pangkat:'IIIb',
      jabatan:'Pengelola Keuangan', unit:'Bagian Keuangan', email:'dewi@kpu.go.id', hp:'08444444444',
      username:'dewi', password:'dewi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Dewi+Rahayu&background=6a1b9a&color=fff&size=80' },
    { id:'u21', nip:'198501012010011001', nama:'Administrator KPU', golongan:'PNS', pangkat:'IVa',
      jabatan:'Administrator Sistem', unit:'Sekretariat', email:'admin@kpu.go.id', hp:'08111111111',
      username:'admin', password:'admin123', role:'admin', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Admin+KPU&background=c62828&color=fff&size=80' },
    { id:'u22', nip:'199001012015032001', nama:'Sri Tutut', golongan:'PNS', pangkat:'IIIa',
      jabatan:'Pranata Komputer', unit:'Bagian TI', email:'sritutut@kpu.go.id', hp:'08222222222',
      username:'pegawai', password:'pegawai123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Sri+Tutut&background=1565c0&color=fff&size=80' },
    { id:'u23', nip:'199503152019081001', nama:'Budi Santoso', golongan:'PPPK', pangkat:'IIIb',
      jabatan:'Analis Kebijakan', unit:'Divisi Perencanaan', email:'budi@kpu.go.id', hp:'08333333333',
      username:'budi', password:'budi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Budi+Santoso&background=2e7d32&color=fff&size=80' },
    { id:'u24', nip:'198808202012042002', nama:'Dewi Rahayu', golongan:'PNS', pangkat:'IIIb',
      jabatan:'Pengelola Keuangan', unit:'Bagian Keuangan', email:'dewi@kpu.go.id', hp:'08444444444',
      username:'dewi', password:'dewi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Dewi+Rahayu&background=6a1b9a&color=fff&size=80' },
    { id:'u25', nip:'198501012010011001', nama:'Administrator KPU', golongan:'PNS', pangkat:'IVa',
      jabatan:'Administrator Sistem', unit:'Sekretariat', email:'admin@kpu.go.id', hp:'08111111111',
      username:'admin', password:'admin123', role:'admin', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Admin+KPU&background=c62828&color=fff&size=80' },
    { id:'u26', nip:'198808202012042002', nama:'Dewi Rahayu', golongan:'PNS', pangkat:'IIIb',
      jabatan:'Pengelola Keuangan', unit:'Bagian Keuangan', email:'dewi@kpu.go.id', hp:'08444444444',
      username:'dewi', password:'dewi123', role:'pegawai', status:'Aktif',
      avatar:'https://ui-avatars.com/api/?name=Dewi+Rahayu&background=6a1b9a&color=fff&size=80' },
...
function savePegawai() {
  ...
  if (editId) {
    ...
    if (idx>=0) {
      ...
      // ── REAL-TIME SYNC: if editing current user, refresh UI immediately ──
      if (editId === currentUser.id) {
        currentUser = users[idx];
        DB.set('session', currentUser.id);
        loadUserUI();
        showToast('✅ Data Anda berhasil diperbarui secara langsung');
      } else {
    ...
    users.push({
      id:'u'+Date.now(), ...fields,
      password: newPw||'pegawai123',
      avatar:`https://ui-avatars.com/api/?name=${encodeURIComponent(nama)}&background=1565c0&color=fff&size=80`
    });
...
function hapusPegawai(id) {
  ...
  renderPegawai(); showToast('🗑 Pegawai berhasil dihapus');
}
